<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Plot_ajax1d.ascx.cs" Inherits="nilnul.proj._web.Plot_ajax1d" %>
...
//			tfmList.appendItem(translate);
		...
		var drawAxis = function (minX, maxX,minY,maxY) {
			...
			yNote.min.textNode = createText(minY, yNote.min.x, yNote.min.y, margin);
			yNote.max.textNode = createText(maxY, yNote.max.x, yNote.max.y, margin);
